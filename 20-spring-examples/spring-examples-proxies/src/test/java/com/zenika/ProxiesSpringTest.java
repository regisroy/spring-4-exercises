...
public class ProxiesSpringTest {
    ...
    public void shouldDisplayProxyImplementation() throws Exception {
        ...
        assertThat(valueOf(serviceNotTransactional.getClass()))
                .isEqualTo("class com.zenika.bean.ServiceImplementationNotTransactional");

        // ICI pas de PB : pas de java.lang.ClassCastException
        ServiceImplementationNotTransactional implementationNotTransactional
                = (ServiceImplementationNotTransactional) serviceNotTransactional;
        ...
        ServiceImplementationTransactional implementationTransactional
                = (ServiceImplementationTransactional) serviceTransactional;
    }
